...
- **Display settings** — density, metadata visibility, icons, lookahead days, open-in-new-tab for note opens
...
5. **Bases filter** — Bases YAML → runtime `where`, then `api.query.tasks`.
